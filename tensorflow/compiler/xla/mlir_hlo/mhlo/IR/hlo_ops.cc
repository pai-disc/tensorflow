...
LogicalResult ConvReifyReturnTypeImpl(
  ...
  std::optional<DenseIntElementsAttr> window_strides_attr = op->getWindowStrides();
...
mlir::ElementsAttr TransposeElementsAttr(
  ...
  // ShapedType type = elements.getType().cast<ShapedType>;
  ShapedType type = cast<ShapedType>(elements.getType());
